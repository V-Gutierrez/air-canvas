...
LEFT_HAND_COLOR_NAMES = ["Cyan", "Magenta", "Green", "Yellow"]
...
RIGHT_HAND_COLOR_NAMES = ["Orange", "Pink", "Light Blue", "White"]

COLOR_TONE_FREQUENCIES = [523, 587, 659, 784]

# Gestures
PINCH_THRESHOLD = 0.08  # Thumb+index distance to cycle color
...
PALETTE_CIRCLE_RADIUS = 36
PALETTE_EDGE_MARGIN = 26
PALETTE_VERTICAL_GAP = 24
PALETTE_GLOW_RADIUS = 16
PALETTE_GLOW_THICKNESS = 5
PALETTE_LABEL_SCALE = 0.5
HAND_COLOR_BLOB_RADIUS = 78
HAND_COLOR_LABEL_SCALE = 0.65
CURSOR_FILL_ALPHA = 0.35
CURSOR_RING_PADDING = 8
RAINBOW_ARC_THICKNESS = 18

GESTURE_OVERLAY_FONT_SCALE = 0.6
...
BG_MUSIC_TEMPO = 0.34
BG_MUSIC_NOTES = [523, 659, 784, 880, 784, 659]
